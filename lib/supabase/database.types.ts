// Generated by the Supabase MCP server (`generate_typescript_types`).
// Regenerate after every schema change:
//   "Pakai supabase-dailylog MCP, generate TypeScript types untuk public
//    schema ke lib/supabase/database.types.ts."
